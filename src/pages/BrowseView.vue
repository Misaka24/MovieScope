...
<style scoped>@media(min-width:1024px){.browse-grid>:deep(.poster-card){width:100%;max-width:170px;justify-self:center}}@media(min-width:1280px){.browse-grid>:deep(.poster-card){max-width:158px}}</style>
