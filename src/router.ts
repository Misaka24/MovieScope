...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: '/title/:type(movie|tv)/:id/credits', name: 'title-credits', component: () => import('./pages/TitleCreditsView.vue') },
    { path: '/title/:type(movie|tv)/:id/images', name: 'title-images', component: () => import('./pages/TitleImagesView.vue') },
