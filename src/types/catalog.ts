...
export interface CatalogKeywordSummary { id: number; mediaType: 'keyword'; name: string }

export type SearchResult = CatalogMedia | CatalogPersonSummary | CatalogKeywordSummary

export interface Genre { id: number; name: string }
export interface GenreGroups { movie: Genre[]; tv: Genre[] }
...
export interface Review { id: string; author: string; content: string; createdAt: string; rating: number | null }
...
export interface TitleDetails extends CatalogMedia {
  ...
  seasons: Array<{ id: number; number: number; name: string; episodes: number; airDate: string | null; poster: string }>
